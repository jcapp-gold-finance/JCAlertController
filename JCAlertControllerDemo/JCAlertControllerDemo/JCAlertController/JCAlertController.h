...
+ (instancetype)actionWithTitle:(NSString *)title style:(JCAlertActionStyle)style handler:(void (^)(JCAlertAction *action))handler;

@property (nonatomic, strong) NSString *title;
@property (nonatomic, readonly) JCAlertActionStyle style;
@property (nonatomic, copy, readonly) void(^handler)(JCAlertAction *action);
