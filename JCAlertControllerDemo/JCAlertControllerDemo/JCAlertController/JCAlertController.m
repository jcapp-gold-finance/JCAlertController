...
- (void)setUI{
    ...
    self.vLine.backgroundColor = [UIColor colorWithRed:184.0/255.0 green:184.0/255.0 blue:184.0/255.0 alpha:1.0];
    self.vVline.backgroundColor = [UIColor colorWithRed:184.0/255.0 green:184.0/255.0 blue:184.0/255.0 alpha:1.0];
...
- (void)setBtn:(UIButton *)btn action:(JCAlertAction *)action{
    UIColor * color = [UIColor colorWithRed:87.0/255.0 green:215.0/255.0 blue:201.0/255.0 alpha:1.0];
    
    if (action.style == JCAlertActionStyleCancel) {
        color = [UIColor colorWithRed:87.0/255.0 green:215.0/255.0 blue:201.0/255.0 alpha:1.0];
    }
